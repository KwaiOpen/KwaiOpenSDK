...
public class UploadFileRequest {
    ...
    public UploadFileRequest(String uploadToken, String endPoint, byte[] fileData) {
        this.uploadToken = uploadToken;
        this.endPoint = endPoint;
        this.fileData = fileData;
    }

    public UploadFileRequest(StartUploadResponse startUploadResponse, byte[] fileData) {
